...
Some BSM theories predict the existence of additional particles with large masses which can decay into a pair of top quarks with very large transverse momenta. The decay products of these highly boosted tops emerge in a collimated ``fat'' cone. Boosted top searches have been carried out at ATLAS, looking for the decay products of a heavy boson known as the $Z'$ and Kaluza-Klein gluons~\cite{Boosted:ATLASExclusion7TeV}. A narrow leptophobic $Z'$ with a mass of less than \SI{1.74}{\TeV} is excluded and a Kaluza-Klein gluon is excluded for masses below \SI{2.07}{\TeV}.
