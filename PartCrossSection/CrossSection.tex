  ...
  \centering
    \begin{minipage}[][][t]{\textwidth}
      \centering
        ...
        \subcaption{Multijet with real lepton}
...
\begin{table}[htbp]
  \centering
    \begin{tabular}{@{}S[input-comparators] % Jet-bin label
        ...
        \bottomrule
    \end{tabular}
    \caption{Results of the SMT multijet tagging-rate measurement in region A) inverted-\met, non-isolated, B) High-\met, non-isolated and C) low-\met, isolated.}
  \label{tab:rsmt}
\end{table}
